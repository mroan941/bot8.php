...
─═ঊঈঊঈ═─╯
*/
define('API_KEY','565474253:AAGmHdnO2PKeDR6Ub8lfu2qF9FTFGzpVc8A');
//-----------------------------------------------------------------------------------------
//فانشن
...
فقط اضف البوت 🚸 الئ مجموعتك وقــم ♻️ برفعه اداري وقم 🐾 بارسال ٲمــر تفعيل ⚡️ 

« لرۈيــه الاوامر ارسل ( الاوامر ) في المجموعة* ✨ »
                    *👣➖➖➖➖👣*
*Welcome dear* 🔻
...
`تابع من ✨ فضلك 🚸` :-  @mroan1235", 
   ...
   [
['text'=>"mroan🚸",'url'=>"https://telegram.me/mroan1235"]
  ],
    ]
    ])
    ]);
...
['text'=>"mroan 🚸",'url'=>"https://telegram.me/mroan1235"]
    ...
    elseif($data=="help" && $fm == $owners2){
            MrPHPBot('editmessagetext',[
                'chat_id'=>$chatid,
     'message_id'=>$messageid,
               'text'=>"اهلا عزيزي 🐾 في قائمة الاوامر 🚸 
...
save("data/$chat_id/welcome.txt","اهلا عزيزي انرت المجموعة ⚡️ يرجى الالتزام 🐾 بالقوانين لكي ♻️ لا يتم طردك تابع :- @mroan1235 🔉");
...
save("data/$chat_id/welcome.txt","اهلا عزيزي انرت المجموعة ⚡️ يرجى الالتزام 🐾 بالقوانين لكي ♻️ لا يتم طردك تابع :- @mroan1235🔉");
SendMessage($chat_id,"تم تفعيل ⚡️ البوت في المجموعة 🐾 لرؤية قوائم الحماية ♻️ ارسل الاوامر 🚸 تابع :- @mroan1235❕");
}
}
...
if ($tc == 'group' | $tc == 'supergroup'){
  ...
  sendAction($chat_id, 'typing');
	MrPHPBot('sendmessage',[
	'chat_id'=>$chat_id,
	'text'=>"تم قفل 🐾 ارسال المعرف ⚡️ في المجموعة 🔉",
  'parse_mode'=>'MarkDown',
	]);
	}
}
...
if ($tc == 'group' | $tc == 'supergroup'){
  ...
  sendAction($chat_id, 'typing');
	MrPHPBot('sendmessage',[
	'chat_id'=>$chat_id,
	'text'=>"تم فتح 🐾 ارسال المعرف ⚡️ في المجموعة 🔉",
  'parse_mode'=>'MarkDown',
	]);
	}
}
...
if ($tc == 'group' | $tc == 'supergroup'){
  ...
  sendAction($chat_id, 'typing');
	MrPHPBot('sendmessage',[
	'chat_id'=>$chat_id,
	'text'=>"تم قفل 🐾 ارسال التوجيه ⚡️ في المجموعة 🔉",
  'parse_mode'=>'MarkDown',
	]);
	}
...
if ($tc == 'group' | $tc == 'supergroup'){
  ...
  sendAction($chat_id, 'typing');
	MrPHPBot('sendmessage',[
	'chat_id'=>$chat_id,
	'text'=>"تم فتح 🐾 ارسال التوجيه ⚡️ في المجموعة 🔉",
  'parse_mode'=>'MarkDown',
	]);
	}
}
...
الاشعارات ➖ ( لقفل او فتح اشعارات الدخول ) ⚡️
التبليغات ➖ ( لقفل او فتح التبليغ بالمجموعه ) 🔻
...
[اضغط هنا وتابع جديدنا ✔️](t.me/mroan1235)",
  'parse_mode'=>'MarkDown',
	]);
	}
 }
...
MrPHPBot('sendmessage',[
 'chat_id'=>$chat_id,
 'text'=>"تم تثبيت ☄ الرسالة بنجاح ⚡️ تابع :- @mroan1235🐾",
  'parse_mode'=>'MarkDown',
 ]);
 }
}
...
MrPHPBot('sendmessage',[
	'chat_id'=>$chat_id,
	'text'=>"تم طرد ☄ العضو بنجاح ⚡️ تابع :- @mroan1235🐾",
  'parse_mode'=>'MarkDown',
	]);
	}
}
...
save("data/$from_id/file.txt","sendtoall");
         MrPHPBot('sendmessage',[
        	'chat_id'=>$Dev,
        	'text'=>"ارسل ⚡️ النص ☄ الان 🌪 تابع @mroan1235 📨",
		'parse_mode'=>'MarkDown',
    		]);
...
SendMessage($chat_id,"تم حفظ ☄ الترحيب بنجاح ⚡️ تابع :- @mroan1235 🐾");
}
}
...
SendMessage($chat_id,"تم حفظ ☄ التكرار بنجاح ⚡️ تابع :- @mroan1235 🐾");
}
else{
MrPHPBot('sendmessage',[
 'chat_id' => $chat_id,
 'text'=>"عذرا اختر ☄ من 1 الى 20 ⚡️ تابع :- @mroan1235 🐾",
              ]);
}
}
}
...
SendMessage($chat_id,"تم تفعيل ☄ الترحيب بنجاح ⚡️ تابع :- @mroan1235🐾");
}
}
elseif ($textmassage == "كتم التكرار" && $from_id == $Dev) {
rmdir("data/spam");
mkdir("data/spam");
SendMessage($chat_id,"#تم تابع @mroan1235");
}
...
elseif (preg_match('/^(.*)([Bb][Oo][Tt])/s',$newchatmemberu) && $lockbots == "✔️" && $newchatmemberu != "SPDLBot") {
 MrPHPBot('sendMessage',[
 'chat_id'=>$chat_id,
 'text'=>'عذرا عزيزي ☄ ممنوع اضافة البوتات 🐾 هنا للاسف تم طرده ⚡️ تابع من فضلك :- @mroan1235 🚸',
  'parse_mode'=>'HTML'
 ]);
 MrPHPBot('kickChatMember',[
 'chat_id'=>$chat_id,
...
MrPHPBot('sendmessage',[
 'chat_id' => $chat_id,
 'text' =>"تم حذف ☄ $num من الرسائل ⚡️ تابع :- @mroan1235 🐾",
              ]);
}else{
MrPHPBot('sendmessage',[
 'chat_id' => $chat_id,
 'text'=>"عذرا اختر ☄ من 1 الى 100 ⚡️ تابع :- @mroan1235🐾",
              ]);
}
}
}
...
MrPHPBot('sendmessage',[
 'chat_id'=>$chat_id,
 'text'=>"تم تغيير ⚡️ اسم المجموعة ☄ بنجاح تابع :- @mroan1235 🐾",
  'parse_mode'=>'MarkDown',
 ]);
 }
}
...
MrPHPBot('sendmessage',[
 'chat_id'=>$chat_id,
 'text'=>"تم تغيير ⚡️ وصف المجموعة ☄ بنجاح تابع :- @mroan1235🐾",
  'parse_mode'=>'MarkDown',
 ]);
 }
}
...
MrPHPBot('sendmessage',[
 'chat_id'=>$chat_id,
 'text'=>"تم الغاء تثبيت ☄ الرسالة بنجاح ⚡️ تابع :- @mroan1235 🐾",
  'parse_mode'=>'MarkDown',
 ]);
 }
}
...
MrPHPBot('sendmessage',[
 'chat_id'=>$chat_id,
 'text'=>"ارسل صورة ⚡️ للمجموعة الان ☄ تابع :- @mroan1235🐾",
  'parse_mode'=>'MarkDown',
 ]);
 }
}
...
if ($tc == 'group' | $tc == 'supergroup'){
  ...
  MrPHPBot('sendmessage',[
  'chat_id'=>$chat_id,
  'text'=>"   اعدادت ♻️ التكرار اختر ☄ من 1 الى 20 🐾 تابع عزيزي 🔉 @mroan1235 🌪",
  'parse_mode'=>'MarkDown',
  'reply_markup'=>json_encode([
  'resize_keyboard'=>true,
  'inline_keyboard'=>[
...
}
{
   MrPHPBot('answerInlineQuery', [
        ...
        'results' => json_encode([[
            ...
            'title' => 'mroan1235 ',
            'input_message_content' => ['parse_mode' => 'MarkDown', 'message_text' => "*Follow SFAEZAR * ⚡️
...
*➖➖➖➖➖➖➖➖➖➖*
• تابعنا ☄ :- فريق @ mroan1235

*Channels📡 : •┇mroan1235┇•*"],
            'reply_markup' => [
                'inline_keyboard' => [
                    [
                        ['text' => "جديدنا", 'url' => 'https://telegram.me/mroan1235']
                    ],
                    [
